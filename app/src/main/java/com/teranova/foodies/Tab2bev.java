...
public class Tab2bev extends Fragment {
    ListView listView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tab2bev, container, false);
        listView  = (ListView) rootView.findViewById(R.id.listviewT2);
        list = new ArrayList<>();
        new Tab2bev.GetFoodList().execute("beverage");
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                for(int l=0; l<jsonarray.length(); l++) {
                    ...
                    FoodListAdapter foodListAdapter = new FoodListAdapter(getActivity(),list);
