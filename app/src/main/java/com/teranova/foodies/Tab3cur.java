...
public class Tab3cur extends Fragment {
    ListView listView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tab3cur, container, false);
        listView  = (ListView) rootView.findViewById(R.id.listviewT3);
        list = new ArrayList<>();
        new Tab3cur.GetFoodList().execute("curry");
        return rootView;
    }
