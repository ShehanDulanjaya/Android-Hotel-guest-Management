...
public class Tab4des extends Fragment {
    ListView listView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tab4des, container, false);
        listView  = (ListView) rootView.findViewById(R.id.listviewT4);
        list = new ArrayList<>();
        new Tab4des.GetFoodList().execute("dessert");
        return rootView;
    }
